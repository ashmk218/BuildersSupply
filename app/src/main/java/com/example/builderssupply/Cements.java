...
public class Cements extends AppCompatActivity {
    DatabaseHelper dbHelper;
    ListView listvw;
    String[] s_main_title;
    String[] s_seller;
    String[] s_sub_title;
    int s_images = R.drawable.constructions;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cements);
        this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        getSupportActionBar().hide();
        dbHelper = new DatabaseHelper(this);
        Cursor res = dbHelper.getCatItems("CONSTRUCTIONS");
        s_main_title = new String[res.getCount()];
        s_seller  = new String[res.getCount()];
        s_sub_title  = new String[res.getCount()];
        if(res.getCount() == 0)
        {
            setAlert("CONSTRUCTIONS");
        }
        int i = 0;
        ...
        listvw = findViewById(R.id.cement_listsvw);
        ...
        listvw.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                toRegister.putExtra("PRD_CAT","CONSTRUCTIONS");
